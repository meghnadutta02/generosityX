  ...
  return (
    <div style={{ minHeight: "60vh" }}>
      {isLoading ? (
        ...
        <div className="p-24">
          <div className="p-8 mt-8 grid md:grid-cols-2 gap-6 bg-gray-300 rounded-md bg-clip-padding backdrop-filter backdrop-blur-3xl bg-opacity-50 border border-gray-100">
            <div className="">
              <CardHeader
                title={
