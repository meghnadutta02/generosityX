...
export default function MyDonationsPage() {
  ...
  return (
    ...
    >
      <h2 className="text-4xl font-bold">Previous Donations</h2>
      {events.length > 0 ? (
        <>
        ...
        >
          You have no previous donation records. Go to{" "}
          <Link to="/items-donate" className="text-blue-500 underline">
            Donations
          </Link>
        </Alert>
      )}
