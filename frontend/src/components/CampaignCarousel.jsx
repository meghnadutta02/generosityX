      ...
      <div name="campaigns" className="py-8">
        ...
        <div className="mt-4 p-8 flex overflow-x-auto">
          {products.slice(0, 5).map((product) => (
            <div
              className="bg-purple-300 rounded-md mr-4 hover:border-2 hover:border-black min-h-50 shadow-md shadow-cyan-600 hover:scale-110 transition ease-in-out delay-50"
              key={product.id}
            >
